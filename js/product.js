...
function passData() {
  ...
  if (document.getElementById("pincodeResult").innerText == "Available") {
    window.open(
      "./order.html?f=ttyshHUIhskjzhg566eyk8kgfdAAWfs5sn23iddbdcUUIok838hschb2osmnfy39SHiJBkjOOk8923982"
      + "&n=" + modelName
...
//                 <Finish Color>] 
var workStation = ["WorkStation","MSTBM01VRT03","NEW","Folding Study Table"
...
function setOdetails() {
  ...
  for(i=0;i<details.length;i++){
    if(details[i][0]==modelName){
      ...
      mainimages[1].src="img/products/"+details[i][1]+"/1.jpg";
      mainimages[2].src="img/products/"+details[i][1]+"/2.jpg";
      mainimages[3].src="img/products/"+details[i][1]+"/3.jpg";
      mainimages[4].src="img/products/"+details[i][1]+"/4.jpg";
      mainimages[5].src="img/products/"+details[i][1]+"/5.jpg";
      mainimages[6].src="img/products/"+details[i][1]+"/6.jpg";
      mainimages[7].src="img/products/"+details[i][1]+"/7.jpg";
